...
struct AboutView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                // Header section with animated coffee cup
                VStack(spacing: 24) {
                    Spacer()
                        .frame(height: 30)

                    // Animated coffee cup with glow effect
                    ZStack {
                        // Glow effect
                        Circle()
                            .fill(
                                RadialGradient(
                                    colors: [Color.brown.opacity(glowIntensity * 0.3), Color.clear],
                                    center: .center,
                                    startRadius: 10,
                                    endRadius: 60
                                )
                ...
                VStack(spacing: 10) {
                    ...
                    Text("Powered by /usr/bin/caffeinate")
